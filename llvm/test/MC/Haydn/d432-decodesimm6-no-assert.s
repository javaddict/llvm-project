...
# Role: object — decodeSImmOperandXStepWide must NEVER abort.
...
# `isUInt<N>(Imm)`. The generated Format E LD slot sub-trie (cases 147/148
...
# objdump pre-fix (a legacy parcel stream that passed the Format E content
