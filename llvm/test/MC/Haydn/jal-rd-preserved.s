...
// ROUNDTRIP: {{.*}}0: 07 0e f8 00 06 00 00 00 00 00 00 00  	{ nop; jal	lr, 12 }
// ROUNDTRIP: {{.*}}c: 07 8b 00 21 00 00 00 00 00 00 00 00  	{ nop; add32	r0, r1, r2 }
...
# Role: object — (F08 / Format E 96 cutover): CallSImm20 fixup must NOT clobber lr.
