...
# CHECK: { nop; nop; pldwwua_post{{ *}}3, r12 }
# ENC-LABEL: f_pldwwua:
# B3.7: brace asm emits Format->Opcode BUNDLE128_FULL (S0-S1-S2 + NOP fill).
# ENC: { nop; nop; pldwwua_post{{ *}}3, r12 } // encoding: [0x3c,0x00,0x00,0x00,0xc0,0x39,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_pldwwua:
  { pldwwua_post 3, r12 }
...
# CHECK: { nop; nop; d_lqhwua_post{{ *}}d7, 2, r4 }
# ENC-LABEL: f_d_lqhwua_post:
# ENC: { nop; nop; d_lqhwua_post{{ *}}d7, 2, r4 } // encoding: [0x48,0xe5,0x01,0x00,0x00,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_lqhwua_post:
  { d_lqhwua_post d7, 2, r4 }

# CHECK-LABEL: <f_d_ltwua_post>:
# CHECK: { nop; nop; d_ltwua_post{{ *}}d3, 0, r6 }
# ENC-LABEL: f_d_ltwua_post:
# ENC: { nop; nop; d_ltwua_post{{ *}}d3, 0, r6 } // encoding: [0x60,0xc7,0x00,0x00,0x40,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_ltwua_post:
...
# ENC: { nop; nop; d_sqhwua_post{{ *}}d1, 3, r8 } // encoding: [0x88,0x79,0x00,0x00,0x00,0x3b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_sqhwua_post:
...
# ENC: { nop; nop; d_stwua_post{{ *}}d2, 0, r10 } // encoding: [0xa0,0x8b,0x00,0x00,0x40,0x3b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_stwua_post:
...
# CHECK: { nop; nop; pldwwua_post{{ *}}0, r1 }
# CHECK: { nop; nop; d_lqhwua_post{{ *}}d0, 0, r1 }
# CHECK: { nop; nop; d_ltwua_post{{ *}}d0, 0, r1 }
...
# CHECK: { nop; nop; pldwwua_post{{ *}}0, r1 }
# CHECK: { nop; nop; d_lqhwua_post{{ *}}d0, 0, r2 }
# CHECK: { nop; nop; d_ltwua_post{{ *}}d1, 0, r2 }
# CHECK: { nop; nop; flar{{ *}}0 }
f_load_stream:
  { pldwwua_post 0, r1 }
