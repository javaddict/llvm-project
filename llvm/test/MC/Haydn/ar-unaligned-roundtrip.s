...
# ENC-LABEL: f_pldwwua:
# ENC: { pldwwua{{ *}}3, r12 } // encoding: [0x3c,0x00,0x00,0x00,0xc0,0x39,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_pldwwua:
  { pldwwua 3, r12 }
...
# ENC-LABEL: f_flar:
# ENC: { flar{{ *}}2 } // encoding: [0x02,0x00,0x00,0x00,0x80,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_flar:
  { flar 2 }
...
# ENC-LABEL: f_wbarwua:
# ENC: { wbarwua{{ *}}1, r3, 1 } // encoding: [0x27,0x00,0x00,0x00,0xc0,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_wbarwua:
  { wbarwua 1, r3, 1 }
...
# ENC: { d_lqhwua_post{{ *}}d7, 2, r4, r5, 1 } // encoding: [0x48,0xe5,0x01,0x00,0x00,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_lqhwua_post:
...
# ENC: { d_ltwua_post{{ *}}d3, 0, r6, r7, 0 } // encoding: [0x60,0xc7,0x00,0x00,0x40,0x3a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_ltwua_post:
...
# ENC: { d_sqhwua_post{{ *}}d1, 3, r8, r9, 1 } // encoding: [0x88,0x79,0x00,0x00,0x00,0x3b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_sqhwua_post:
...
# ENC: { d_stwua_post{{ *}}d2, 0, r10, r11, 0 } // encoding: [0xa0,0x8b,0x00,0x00,0x40,0x3b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
f_d_stwua_post:
...
# CHECK: { pldwwua{{ *}}0, r1; add32{{ *}}r2, r3, r4; nop }
# ENC-LABEL: f_dual_pldw_add:
# ENC: { pldwwua{{ *}}0, r1; add32{{ *}}r2, r3, r4 }
f_dual_pldw_add:
