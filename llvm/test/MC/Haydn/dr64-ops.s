...
# CHECK: {{.*}}60: 87 43 02 07 00 00 00 00 00 00 00 00 { nop; d_ldw_with_imm d0, r7, 0 }
# CHECK: 6c: 87 43 12 88 00 00 00 00 00 00 00 00 { nop; d_ldw_with_imm d1, r8, 8 }
# CHECK: {{.*}}78: 87 43 f2 c0 03 00 00 00 00 00 00 00 { nop; d_ldw_with_imm d15, r0, -4 }
# CHECK: {{.*}}84: 87 43 2a 09 00 00 00 00 00 00 00 00 { nop; d_sdw_with_imm d2, r9, 0 }
# CHECK: {{.*}}90: 87 43 3a 0a 03 00 00 00 00 00 00 00 { nop; d_sdw_with_imm d3, r10, -16 }
# CHECK: 9c: 87 43 0a 81 00 00 00 00 00 00 00 00 { nop; d_sdw_with_imm d0, r1, 8 }
# CHECK: a8: 87 43 13 42 00 00 00 00 00 00 00 00 { nop; s_lw_with_imm r1, r2, 4 }
# CHECK: b4: 87 43 33 04 00 00 00 00 00 00 00 00 { nop; s_lw_with_imm r3, r4, 0 }
