...
# RUN: FileCheck --input-file=%S/../../../lib/Target/Haydn/HaydnInstrInfoAuto.td %s \
# RUN:   --check-prefix=TD
# REQUIRES: haydn-registered-target
#
# REGRESSION TEST: hypothesized HaydnInstrInfoAuto.td encodings (FmtALU64
# ADD64S Inst{}) must not bare-encode to zeros.
#
