...
# CHECK: {{.*}}0: 07 0a 12 00 23 01 00 00 00 00 00 00 { nop; lui r1, 291 }
...
# value (31).
# CHECK: 3c: 07 0f 32 03 ce ff 07 00 00 00 00 00 { nop; addi32 r3, r3, -100 }
    LUI R3, 0xFFF
