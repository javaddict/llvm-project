...
define <2 x i32> @ambient_two_epoch(<2 x i32> %a1, <2 x i32> %b1,
  ...
  call void @llvm.haydn.x2slt32(<2 x i32> %a1, <2 x i32> %b1)
  %r1 = call <2 x i32> @llvm.haydn.x2movt32(<2 x i32> %f1, <2 x i32> %t1)
  call void @llvm.haydn.x2slt32(<2 x i32> %a2, <2 x i32> %b2)
  ...
  %keep = call <2 x i32> @llvm.haydn.x2add32s(<2 x i32> %a1, <2 x i32> %a2)
