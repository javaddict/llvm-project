...
// ASM: csrw{{(\.s[012])?}} 44, {{r[0-9]+}}
// ASM: csrw{{(\.s[012])?}} 45, {{r[0-9]+}}
...
// ASM-LABEL: cb_store_32x2_3arg:
// ASM: d_sdw_cb_imm{{(\.s[012])?}}
