...
; CHECK-NEXT:    { ld32 r1, r1, 0; ld32 r2, r2, 0; x2slli32 d1, d0, 16 }
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { st32 r1, sp, 2; x2srai32 d0, d0, 16; x2srai32 d1, d1, 16 } // 4-byte Folded Spill
...
; CHECK-NEXT:    { slli64 d0, d0, 32; x2slli32 d2, d2, 16 }
; CHECK-NEXT:    { srli64 d0, d0, 32; x2srai32 d2, d2, 16 }
