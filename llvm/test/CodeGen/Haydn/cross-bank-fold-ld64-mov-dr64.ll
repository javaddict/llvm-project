...
; CHECK-NEXT:    { nop; x2slli32 d1, d0, 16 }
; CHECK-NEXT:    { nop; st32 r1, sp, 2 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; x2srai32 d0, d0, 16 }
; CHECK-NEXT:    { nop; x2srai32 d1, d1, 16 }
; CHECK-NEXT:    { nop; st32 r2, sp, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; x2slli32 d2, d0, 16 }
...
; CHECK-NEXT:    { nop; fmula16.ls00 d3, d0, d1 }
; CHECK-NEXT:    { nop; x2srai32 d2, d2, 16 }
; CHECK-NEXT:    { nop; fmula16.ls11 d3, d0, d1 }
