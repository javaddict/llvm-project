...
; CHECK-NEXT:    { xor32 r0, r0, r0; subi32 sp, sp, 8 }
; CHECK-NEXT:    .cfi_def_cfa_offset 8
; CHECK-NEXT:    { nop; nop; s_lw_post_imm r2, r1, 1 }
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { nop; ld32 r1, r1, 0 }
; CHECK-NEXT:    { nop; nop }
...
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { add32 r2, r2, r3; ld32 r1, r1, 2 }
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { nop; add32 r1, r2, r1 }
; CHECK-NEXT:    { nop; addi32 sp, sp, 8 }
; CHECK-NEXT:    .cfi_def_cfa sp, 0
...
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { seq32 r2, r1, r2; addi32 r3, r0, 1 }
; CHECK-NEXT:    { addi32 r1, r0, 0; xori32 r2, r2, 1 }
...
; CHECK-NEXT:    { slli32 r1, r1, 3; addi32 r2, r2, global_structs }
; CHECK-NEXT:    { nop; add32 r1, r2, r1 }
; CHECK-NEXT:    { nop; ld32 r1, r1, 0 }
; CHECK-NEXT:    { nop; addi32 sp, sp, 8 }
; CHECK-NEXT:    .cfi_def_cfa sp, 0
