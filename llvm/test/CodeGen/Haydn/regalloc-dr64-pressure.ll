...
; CHECK-NEXT:    { st32 lr, sp, 13; nop }
; CHECK-NEXT:    { addi32_w r1, sp, 8; nop }
; CHECK-NEXT:    { st64 d12, r1, 0; nop }
; CHECK-NEXT:    { st64 d11, r1, 1; nop }
; CHECK-NEXT:    { st64 d10, r1, 2; nop }
; CHECK-NEXT:    { st64 d9, r1, 3; nop }
; CHECK-NEXT:    { st64 d8, r1, 4; nop }
; CHECK-NEXT:    { addi32_w r1, r0, 545; nop }
; CHECK-NEXT:    { or64 d8, d1, d1; sext32t64 d1, r1 }
...
; CHECK-NEXT:    { or64 d0, d11, d11; nop }
; CHECK-NEXT:    { jal_w lr, use_i64; nop }
; CHECK-NEXT:    { add64 d0, d8, d12; xor32 r0, r0, r0 }
; CHECK-NEXT:    { add64 d0, d9, d0; nop }
; CHECK-NEXT:    { add64 d0, d10, d0; nop }
; CHECK-NEXT:    { add64 d0, d12, d0; nop }
...
; CHECK-NEXT:    { add64 d0, d8, d0; nop }
; CHECK-NEXT:    { add64 d0, d9, d0; nop }
; CHECK-NEXT:    { addi32_w r1, r0, 4760; nop }
; CHECK-NEXT:    { add64 d0, d10, d0; sext32t64 d1, r1 }
; CHECK-NEXT:    { add64 d0, d12, d0; slli64 d1, d1, 32 }
; CHECK-NEXT:    { srli64 d1, d1, 32; add64 d0, d0, d11 }
; CHECK-NEXT:    { add64 d0, d0, d1; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { ld64 d12, sp, 1; nop }
; CHECK-NEXT:    { ld64 d11, sp, 2; nop }
; CHECK-NEXT:    { ld64 d10, sp, 3; nop }
; CHECK-NEXT:    { ld64 d9, sp, 4; nop }
; CHECK-NEXT:    { ld64 d8, sp, 5; nop }
; CHECK-NEXT:    { ld32 lr, sp, 13; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 56; nop }
...
; CHECK-NEXT:    { addi32_w r0, r0, 68; nop }
; CHECK-NEXT:    { st32_reg lr, sp, r0; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w r1, sp, 8; nop }
; CHECK-NEXT:    { st64 d14, r1, 0; nop }
; CHECK-NEXT:    { st64 d13, r1, 1; nop }
; CHECK-NEXT:    { st64 d12, r1, 2; nop }
; CHECK-NEXT:    { st64 d11, r1, 3; nop }
; CHECK-NEXT:    { st64 d10, r1, 4; nop }
; CHECK-NEXT:    { st64 d9, r1, 5; nop }
; CHECK-NEXT:    { st64 d8, r1, 6; nop }
; CHECK-NEXT:    { or64 d9, d1, d1; or64 d10, d2, d2 }
; CHECK-NEXT:    { or64 d11, d3, d3; nop }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
...
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { add64 d1, d8, d9; xor32 r0, r0, r0 }
; CHECK-NEXT:    { add64 d1, d1, d10; nop }
; CHECK-NEXT:    { add64 d1, d1, d11; nop }
; CHECK-NEXT:    { add64 d1, d1, d12; nop }
; CHECK-NEXT:    { add64 d1, d1, d13; nop }
; CHECK-NEXT:    { add64 d1, d1, d14; nop }
; CHECK-NEXT:    { add64 d0, d1, d0; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { ld64 d14, sp, 1; nop }
; CHECK-NEXT:    { ld64 d13, sp, 2; nop }
; CHECK-NEXT:    { ld64 d12, sp, 3; nop }
; CHECK-NEXT:    { ld64 d11, sp, 4; nop }
; CHECK-NEXT:    { ld64 d10, sp, 5; nop }
; CHECK-NEXT:    { ld64 d9, sp, 6; nop }
; CHECK-NEXT:    { ld64 d8, sp, 7; nop }
; CHECK-NEXT:    { ld32 lr, sp, 17; nop }
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { subi32 sp, sp, 88; nop }
; CHECK-NEXT:    { addi32_w r0, r0, 84; nop }
; CHECK-NEXT:    { st32_reg lr, sp, r0; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w r1, sp, 16; nop }
; CHECK-NEXT:    { st64 d15, r1, 0; nop }
; CHECK-NEXT:    { st64 d14, r1, 1; nop }
; CHECK-NEXT:    { st64 d13, r1, 2; nop }
; CHECK-NEXT:    { st64 d12, r1, 3; nop }
; CHECK-NEXT:    { st64 d11, r1, 4; nop }
; CHECK-NEXT:    { st64 d10, r1, 5; nop }
; CHECK-NEXT:    { st64 d9, r1, 6; nop }
; CHECK-NEXT:    { st64 d8, r1, 7; nop }
; CHECK-NEXT:    { addi32_w r1, r0, 1; nop }
; CHECK-NEXT:    { sext32t64 d0, r1; nop }
; CHECK-NEXT:    { addi32_w r1, r0, 2; nop }
; CHECK-NEXT:    { slli64 d0, d0, 32; sext32t64 d10, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 3; nop }
; CHECK-NEXT:    { srli64 d0, d0, 32; sext32t64 d13, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 4; nop }
; CHECK-NEXT:    { slli64 d10, d10, 32; sext32t64 d15, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 5; nop }
; CHECK-NEXT:    { slli64 d13, d13, 32; sext32t64 d12, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 6; nop }
; CHECK-NEXT:    { slli64 d15, d15, 32; sext32t64 d8, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 7; nop }
; CHECK-NEXT:    { slli64 d12, d12, 32; sext32t64 d14, r1 }
; CHECK-NEXT:    { addi32_w r1, r0, 9; nop }
; CHECK-NEXT:    { slli64 d8, d8, 32; sext32t64 d9, r1 }
...
; CHECK-NEXT:    { srli64 d9, d9, 32; nop }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; st64 d0, sp, 1 } // 8-byte Folded Spill
; CHECK-NEXT:    // 8-byte Spill
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { or64 d0, d10, d10; nop }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d11, d0, d0; or64 d0, d13, d13; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d13, d0, d0; or64 d0, d15, d15; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d15, d0, d0; or64 d0, d12, d12; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d10, d0, d0; or64 d0, d8, d8; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d8, d0, d0; or64 d0, d14, d14; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d12, d0, d0 }
; CHECK-NEXT:    { addi32_w r1, r0, 8; nop }
; CHECK-NEXT:    { sext32t64 d0, r1; nop }
; CHECK-NEXT:    { slli64 d0, d0, 32; nop }
; CHECK-NEXT:    { srli64 d0, d0, 32; nop }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { or64 d14, d0, d0; or64 d0, d9, d9; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
...
; CHECK-NEXT:    { srli64 d0, d0, 32; nop }
; CHECK-NEXT:    { jal_w lr, consume_i64; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; ld64 d1, sp, 1 } // 8-byte Folded Reload
; CHECK-NEXT:    // 8-byte Reload
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { add64 d1, d1, d11; nop }
; CHECK-NEXT:    { add64 d1, d1, d13; nop }
; CHECK-NEXT:    { add64 d1, d1, d15; nop }
; CHECK-NEXT:    { add64 d1, d1, d10; nop }
; CHECK-NEXT:    { add64 d1, d1, d8; nop }
; CHECK-NEXT:    { add64 d1, d1, d12; nop }
; CHECK-NEXT:    { add64 d1, d1, d14; nop }
; CHECK-NEXT:    { add64 d1, d1, d9; nop }
; CHECK-NEXT:    { add64 d0, d1, d0; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { ld64 d15, sp, 2; nop }
; CHECK-NEXT:    { ld64 d14, sp, 3; nop }
; CHECK-NEXT:    { ld64 d13, sp, 4; nop }
; CHECK-NEXT:    { ld64 d12, sp, 5; nop }
; CHECK-NEXT:    { ld64 d11, sp, 6; nop }
; CHECK-NEXT:    { ld64 d10, sp, 7; nop }
; CHECK-NEXT:    { ld64 d9, sp, 8; nop }
; CHECK-NEXT:    { ld64 d8, sp, 9; nop }
; CHECK-NEXT:    { ld32 lr, sp, 21; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 88; nop }
; CHECK-NEXT:    { jalr_w r0, lr, 0; nop }
entry:
