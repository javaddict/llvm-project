...
; CHECK-NEXT:    { subi32 sp, sp, 16 }
; CHECK-NEXT:    { addi32_w r2, sp, 8 }
; CHECK-NEXT:    { st32 lr, r2, 0 }
; CHECK-NEXT:    { st32 r8, r2, 4 }
; CHECK-NEXT:    { move32 r8, r1 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { xor32 r0, r0, r0; add32 r1, r8, r1; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { ld32 lr, sp, 8 }
; CHECK-NEXT:    { ld32 r8, sp, 12 }
...
; CHECK-NEXT:    { addi32_w r6, sp, 8 }
; CHECK-NEXT:    { st32 lr, r6, 0 }
; CHECK-NEXT:    { st32 fp, r6, 4 }
; CHECK-NEXT:    { st32 r11, r6, 8 }
; CHECK-NEXT:    { st32 r10, r6, 12 }
; CHECK-NEXT:    { st32 r9, r6, 16 }
; CHECK-NEXT:    { st32 r8, r6, 20 }
; CHECK-NEXT:    { move32 r8, r2; move32 r9, r3; nop }
; CHECK-NEXT:    { move32 r10, r4; move32 r11, r5; nop }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 fp, r1; move32 r1, r8; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r8, r1; move32 r1, r9; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r9, r1; move32 r1, r10; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r10, r1; move32 r1, r11; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
...
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { ld32 lr, sp, 8 }
; CHECK-NEXT:    { ld32 fp, sp, 12 }
; CHECK-NEXT:    { ld32 r11, sp, 16 }
; CHECK-NEXT:    { ld32 r10, sp, 20 }
; CHECK-NEXT:    { ld32 r9, sp, 24 }
; CHECK-NEXT:    { ld32 r8, sp, 28 }
...
; CHECK-NEXT:    { or64 d11, d3, d3 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d8, d0, d0; or64 d0, d9, d9 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d9, d0, d0; or64 d0, d10, d10 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d10, d0, d0; or64 d0, d11, d11 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d11, d0, d0; or64 d0, d8, d8 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d12, d0, d0; or64 d0, d9, d9 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d13, d0, d0; or64 d0, d10, d10 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d14, d0, d0; or64 d0, d11, d11 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
...
; CHECK-NEXT:    { addi32_w r5, sp, 28 }
; CHECK-NEXT:    { st32 lr, r5, 0 }
; CHECK-NEXT:    { st32 r11, r5, 4 }
; CHECK-NEXT:    { st32 r10, r5, 8 }
; CHECK-NEXT:    { st32 r9, r5, 12 }
; CHECK-NEXT:    { st32 r8, r5, 16 }
; CHECK-NEXT:    { addi32_w r5, sp, 8 }
; CHECK-NEXT:    { st64 d9, r5, 0 }
; CHECK-NEXT:    { st64 d8, r5, 8 }
; CHECK-NEXT:    { move32 r8, r2; move32 r9, r3; or64 d8, d0, d0 }
; CHECK-NEXT:    { move32 r10, r4; or64 d9, d1, d1; nop }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r11, r1; move32 r1, r8; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r8, r1; move32 r1, r9; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { move32 r9, r1; move32 r1, r10; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d0, d8, d8; move32 r10, r1 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d8, d0, d0; or64 d0, d9, d9 }
; CHECK-NEXT:    { jal_w lr, use_i64 }
; CHECK-NEXT:    { add32 r1, r11, r8; add64 d0, d8, d0; xor32 r0, r0, r0 }
; CHECK-NEXT:    { add32 r1, r1, r9 }
; CHECK-NEXT:    { add32 r1, r1, r10 }
; CHECK-NEXT:    { sext32t64 d1, r1 }
; CHECK-NEXT:    { slli64 d1, d1, 32 }
; CHECK-NEXT:    { srli64 d1, d1, 32 }
; CHECK-NEXT:    { add64 d0, d0, d1 }
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { ld64 d9, sp, 8 }
; CHECK-NEXT:    { ld64 d8, sp, 16 }
; CHECK-NEXT:    { ld32 lr, sp, 28 }
; CHECK-NEXT:    { ld32 r11, sp, 32 }
; CHECK-NEXT:    { ld32 r10, sp, 36 }
; CHECK-NEXT:    { ld32 r9, sp, 40 }
; CHECK-NEXT:    { ld32 r8, sp, 44 }
