...
; CHECK-NEXT:    { st32 lr, r6, 0; nop; nop }
; CHECK-NEXT:    { st32 fp, r6, 4; nop; nop }
; CHECK-NEXT:    { st32 r11, r6, 8; nop; nop }
; CHECK-NEXT:    { st32 r10, r6, 12; nop; nop }
; CHECK-NEXT:    { st32 r9, r6, 16; nop; nop }
; CHECK-NEXT:    { st32 r8, r6, 20; nop; nop }
...
; CHECK-NEXT:    { st32 lr, r5, 0; nop; nop }
; CHECK-NEXT:    { st32 r11, r5, 4; nop; nop }
; CHECK-NEXT:    { st32 r10, r5, 8; nop; nop }
; CHECK-NEXT:    { st32 r9, r5, 12; nop; nop }
; CHECK-NEXT:    { st32 r8, r5, 16; nop; nop }
; CHECK-NEXT:    { addi32_w r5, sp, 8; nop; nop }
; CHECK-NEXT:    { st64 d9, r5, 0; nop; nop }
; CHECK-NEXT:    { st64 d8, r5, 8; nop; nop }
; CHECK-NEXT:    { nop; move32 r9, r3; move32 r8, r2 }
; CHECK-NEXT:    { nop; or64 d8, d0, d0; move32 r10, r4 }
; CHECK-NEXT:    { nop; nop; or64 d9, d1, d1 }
; CHECK-NEXT:    { jal_w lr, use_i32; nop; nop }
; CHECK-NEXT:    { nop; move32 r1, r8; move32 r11, r1 }
; CHECK-NEXT:    { nop; nop; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32; nop; nop }
; CHECK-NEXT:    { nop; move32 r1, r9; move32 r8, r1 }
; CHECK-NEXT:    { nop; nop; xor32 r0, r0, r0 }
...
; CHECK-NEXT:    { nop; nop; xor32 r0, r0, r0 }
; CHECK-NEXT:    { jal_w lr, use_i32; nop; nop }
; CHECK-NEXT:    { move32 r10, r1; xor32 r0, r0, r0; or64 d0, d8, d8 }
; CHECK-NEXT:    { jal_w lr, use_i64; nop; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; or64 d0, d9, d9; or64 d8, d0, d0 }
; CHECK-NEXT:    { jal_w lr, use_i64; nop; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; add64 d0, d8, d0; add32 r1, r11, r8 }
; CHECK-NEXT:    { nop; nop; add32 r1, r1, r9 }
; CHECK-NEXT:    { nop; nop; add32 r1, r1, r10 }
; CHECK-NEXT:    { nop; sext32t64 d1, r1; nop }
...
; CHECK-NEXT:    { nop; ld32 r11, sp, 32; nop }
; CHECK-NEXT:    { nop; ld32 r10, sp, 36; nop }
