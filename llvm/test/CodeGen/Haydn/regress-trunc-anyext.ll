...
; CHECK-NEXT:    { seq32 r2, r1, r2; sltu32 r1, r1, r4 }
; CHECK-NEXT:    { slt32 r3, r4, r3; xori32 r2, r2, 1 }
; CHECK-NEXT:    { xori32 r1, r1, 1; xori32 r3, r3, 1 }
; CHECK-NEXT:    { movt32 r3, r1, r2; nop }
; CHECK-NEXT:    { addi32_w r1, r0, 1; nop }
; CHECK-NEXT:    { not32 r2, r3; nop }
; CHECK-NEXT:    { and32 r1, r2, r1; nop }
; CHECK-NEXT:    { bnez_w r1, .LBB0_2; nop }
; CHECK-NEXT:  // %bb.1: // %yes
...
; CHECK-NEXT:    { seq32 r1, r1, r2; move32_dr_l r2, d1 }
