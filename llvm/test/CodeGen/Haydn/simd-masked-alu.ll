...
define i64 @test_x2clamp32(i64 %a, i64 %b, <2 x i32> %acc) {
  %bc.1 = bitcast i64 %a to <2 x i32>
  %bc.2 = bitcast i64 %b to <2 x i32>
  %call.3 = call <2 x i32> @llvm.haydn.x2clamp32(<2 x i32> %acc, <2 x i32> %bc.1, <2 x i32> %bc.2)
...
define i64 @test_x4clamp16(i64 %a, i64 %b, <4 x i16> %acc) {
  %bc.4 = bitcast i64 %a to <4 x i16>
  %bc.5 = bitcast i64 %b to <4 x i16>
  %call.6 = call <4 x i16> @llvm.haydn.x4clamp16(<4 x i16> %acc, <4 x i16> %bc.4, <4 x i16> %bc.5)
...
define <2 x i32> @test_x2add32s_masked_eq(<2 x i32> %a, <2 x i32> %b, <2 x i32> %mask_val) {
  call void @llvm.haydn.x2seq32(<2 x i32> %a,<2 x i32> %mask_val)
...
define <4 x i16> @test_x4sub16s_masked_sle(<4 x i16> %a, <4 x i16> %b, <4 x i16> %mask_val) {
  call void @llvm.haydn.x4sle16(<4 x i16> %a,<4 x i16> %mask_val)
