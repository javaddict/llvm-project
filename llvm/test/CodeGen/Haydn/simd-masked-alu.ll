...
; CHECK-DAG: x2clamp32
  ...
  %call.3 = call <2 x i32> @llvm.haydn.x2clamp32(<2 x i32> %bc.1, <2 x i32> %bc.2, <2 x i32> %bc.1)
...
; CHECK-DAG: x4clamp16
  ...
  %call.6 = call <4 x i16> @llvm.haydn.x4clamp16(<4 x i16> %bc.4, <4 x i16> %bc.5, <4 x i16> %bc.4)
