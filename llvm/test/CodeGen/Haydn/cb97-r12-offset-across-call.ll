...
; The srem-by-constant expansion uses shifts in either register-register or
; immediate form, depending on whether the shift amount folds into the opcode.
...
; CHECK: {{s_lw_[a-z_]*|s_sw_[a-z_]*|addi32}}
