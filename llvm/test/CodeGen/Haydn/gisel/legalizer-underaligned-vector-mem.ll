...
;
; Under-aligned 64-bit vectors bitcast to s64 and take the scalar lower path.
; They must NOT scalarize: scalarizing a DR-resident vector store drops the
; per-lane extract and writes lane 0 into every byte.
