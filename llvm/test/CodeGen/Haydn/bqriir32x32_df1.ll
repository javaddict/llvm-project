...
; CHECK-NEXT:    { ld32 r7, r1, 1; ld32 r6, r1, 0 }
; CHECK-NEXT:    { ld32 r12, r1, 6; ld32 r9, r1, 7 }
...
; CHECK-NEXT:    { sub64 d5, d5, d6; addi32 r5, r5, 1 }
; CHECK-NEXT:    { srl64 d5, d5, r7; slt32 r10, r5, r4 }
; CHECK-NEXT:    { move32_dr_l r9, d5; addi32 r3, r3, 4 }
