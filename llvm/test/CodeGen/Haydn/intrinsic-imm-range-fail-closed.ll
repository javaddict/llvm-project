...
;
; REGRESSION TEST: public intrinsic ImmArg arms must fail-closed on
; out-of-range immediates. MC N-bit-truncates otherwise (silent wrong
; code). Sat/round SIMD shifts (X2SRAI32R / X4SRAI16R) are the NatureDSP
; pack/round matrix seats.
;
; Bug: GPR32 RI5 shifts, DR64 RI6 shifts, SIN_COS/ARCTAN uimm4, and CB
; IMM stride (product member simm8) emitted the raw constant with no
; range check. Sibling X4SELI16 already rejected ImmVal>15.
