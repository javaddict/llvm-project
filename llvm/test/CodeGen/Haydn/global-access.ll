...
; CHECK:  	{ 	xor32	r0, r0, r0 }
; CHECK:  	{ 	subi32	sp, sp, 8 }
; CHECK:  	{ 	lui	r1, g_long; 	subi32	sp, sp, 8; 	nop }
; CHECK:  	{ 	addi32{{(_w)?}}	r1, r1, g_long }
...
; CHECK:  	{ 	xor32	r0, r0, r0 }
; CHECK:  	{ 	subi32	sp, sp, 8 }
; CHECK:  	{ 	lui	r1, local_const }
; CHECK:  	{ 	addi32{{(_w)?}}	r1, r1, local_const }
; CHECK:  	{ 	ld32	r1, r1, 0 }
; CHECK:  	{ 	xor32	r0, r0, r0 }
; CHECK:  	{ 	addi32{{(_w)?}}	sp, sp, 8 }
; CHECK:  	{ 	jalr_w{{(\.s[012])?}}	r0, lr, 0 }
...
; CHECK:  	{ 	xor32	r0, r0, r0 }
; CHECK:  	{ 	subi32	sp, sp, 8 }
; CHECK:  	{ 	lui	r2, g_array }
; CHECK:  	{ 	addi32{{(_w)?}}	r3, r0, 2 }
; CHECK:  	{ 	sll32	r1, r1, r3 }
; CHECK:  	{ 	addi32{{(_w)?}}	r2, r2, g_array }
