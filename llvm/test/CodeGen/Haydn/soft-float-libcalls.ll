...
; CHECK-LABEL: fadd:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __addsf3
  %r = fadd float %a, %b
  ret float %r
}
...
; CHECK-LABEL: dmul:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __muldf3
  %r = fmul double %a, %b
  ret double %r
}
...
; CHECK-LABEL: d2f:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __truncdfsf2
...
; CHECK-LABEL: f2i:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __fixsfsi
...
; CHECK-LABEL: feq:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __eqsf2
...
; CHECK-NOT: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, copysign
; CHECK-NOT: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __copysign
; CHECK: and32
; CHECK: or32
...
; CHECK-LABEL: ffloor:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, floorf
...
; CHECK-LABEL: fmin:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, fminf
...
; CHECK-LABEL: fmax:
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, fmaxf
...
; CHECK-LABEL: fisnan:
; CHECK-NOT: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, __
; CHECK-NOT: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}}	lr, isnan
; CHECK: jalr
