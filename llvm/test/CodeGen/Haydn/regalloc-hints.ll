...
; CHECK:       // #<spill-kpi> @test_args_return spills=0 spill-bytes=0 reloads=0 reload-bytes=0
...
; CHECK:       // #<spill-kpi> @test_i64_arg_return spills=0 spill-bytes=0 reloads=0 reload-bytes=0
; CHECK-NEXT:  // %bb.0: // %entry
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
...
; CHECK:       // #<spill-kpi> @test_local_temps spills=0 spill-bytes=0 reloads=0 reload-bytes=0
; CHECK-NEXT:  // %bb.0: // %entry
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
...
; CHECK:       // #<spill-kpi> @test_forces_callee_saved spills=8 spill-bytes=32 reloads=8 reload-bytes=32
; CHECK-NEXT:  // %bb.0: // %entry
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
...
; CHECK-NEXT:    { nop; jal lr, get_value; nop }
