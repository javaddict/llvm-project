...
; ASM-NEXT:    { nop; nop }
; ASM-NEXT:    { add32 r1, r1, r2; ld32 r3, r3, 0 }
; ASM-NEXT:    { nop; nop }
; ASM-NEXT:    { nop; add32 r1, r1, r3 }
; ASM-NEXT:    { nop; addi32 sp, sp, 8 }
; ASM-NEXT:    .cfi_def_cfa sp, 0
...
; ASM-NEXT:    { slt32 r6, r3, r6; ld32 r5, r4, 0 }
; ASM-NEXT:    { nop; addi32 r7, r4, 4 }
; ASM-NEXT:    { nop; nop; s_lw_post_imm r4, r2, 1 }
; ASM-NEXT:    { nop; bnez r6, .LBB2_5 }
; ASM-NEXT:    { nop; beqz r0, .LBB2_3 }
...
; ASM-NEXT:    { nop; nop; s_lw_post_imm r4, r2, 1 }
; ASM-NEXT:    { nop; beqz r0, .LBB2_4 }
; ASM-NEXT:  .LBB2_3:                                // %loop
; ASM-NEXT:    { ld32 r5, r7, 0; mull r6, r5, r4 }
; ASM-NEXT:    { nop; addi32 r4, r0, 3 }
; ASM-NEXT:    { slt32 r3, r3, r4; addi32 r7, r7, 4 }
; ASM-NEXT:    { nop; nop; s_lw_post_imm r4, r2, 1 }
; ASM-NEXT:    { nop; beqz r3, .LBB2_2 }
; ASM-NEXT:  .LBB2_4:
; ASM-NEXT:    { nop; add32 r1, r1, r6 }
; ASM-NEXT:  .LBB2_5:
; ASM-NEXT:    { nop; mull r2, r5, r4 }
; ASM-NEXT:    { nop; add32 r1, r1, r2 }
; ASM-NEXT:  .LBB2_6:                                // %exit
; ASM-NEXT:    { nop; addi32 sp, sp, 16 }
; ASM-NEXT:    .cfi_def_cfa sp, 0
; ASM-NEXT:    { nop; jalr r0, lr, 0 }
; PREGREEDY-LABEL: name: qor_dual_load_mac_stream
; PREGREEDY: bb.0.entry:
; PREGREEDY-NEXT:   successors: %bb.1(0x50000000), %bb.9(0x30000000)
; PREGREEDY-NEXT:   liveins: $r1, $r2, $r3
; PREGREEDY-NEXT: {{  $}}
...
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.9:
; PREGREEDY-NEXT:   successors: %bb.7(0x80000000)
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT:   B %bb.7
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.1.loop.preheader:
; PREGREEDY-NEXT:   successors: %bb.2(0x80000000)
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT:   LoopStart [[COPY2]], -2
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.2.loop:
; PREGREEDY-NEXT:   successors: %bb.3(0x40000000), %bb.8(0x40000000)
; PREGREEDY-NEXT: {{  $}}
...
; PREGREEDY-NEXT:   BEQZ_W [[SLT32_1]], %bb.3
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.8:
; PREGREEDY-NEXT:   successors: %bb.6(0x80000000)
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT:   B %bb.6
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.3.loop:
; PREGREEDY-NEXT:   successors: %bb.4(0x40000000), %bb.5(0x40000000)
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT:   [[MULL:%[0-9]+]]:gpr32 = MULL [[LD32_]], [[S_LW_POST_IMM]]
; PREGREEDY-NEXT:   [[LOADI32_2:%[0-9]+]]:gpr32 = LOADI32 3
; PREGREEDY-NEXT:   [[LD32_:%[0-9]+]]:gpr32 = LD32 [[ADDI32_]], 0 :: (load (s32) from %ir.lsr.iv1 + 4)
; PREGREEDY-NEXT:   [[ADDI32_1:%[0-9]+]]:gpr32 = ADDI32 [[ADDI32_]], 4
; PREGREEDY-NEXT:   [[SLT32_2:%[0-9]+]]:gpr32 = SLT32 [[COPY2]], [[LOADI32_2]]
; PREGREEDY-NEXT:   [[S_LW_POST_IMM:%[0-9]+]]:gpr32, [[COPY1:%[0-9]+]]:gpr32 = S_LW_POST_IMM [[COPY1]], 1 :: (load (s32) from %ir.lsr.iv + 4)
; PREGREEDY-NEXT:   BNEZ_W [[SLT32_2]], %bb.5
; PREGREEDY-NEXT:   B %bb.4
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.4.loop:
; PREGREEDY-NEXT:   successors: %bb.4(0x7c000000), %bb.5(0x04000000)
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT:   [[LOADI32_:%[0-9]+]]:gpr32 = ADD32 [[LOADI32_]], [[MULL]]
; PREGREEDY-NEXT:   [[MULL:%[0-9]+]]:gpr32 = MULL [[LD32_]], [[S_LW_POST_IMM]]
; PREGREEDY-NEXT:   [[LD32_:%[0-9]+]]:gpr32 = LD32 [[ADDI32_1]], 0 :: (load (s32) from %ir.lsr.iv1 + 8)
; PREGREEDY-NEXT:   [[S_LW_POST_IMM1:%[0-9]+]]:gpr32, [[COPY1:%[0-9]+]]:gpr32 = S_LW_POST_IMM [[COPY1]], 1 :: (load (s32) from %ir.lsr.iv + 8)
; PREGREEDY-NEXT:   [[S_LW_POST_IMM:%[0-9]+]]:gpr32 = COPY [[S_LW_POST_IMM1]]
; PREGREEDY-NEXT:   [[ADDI32_1:%[0-9]+]]:gpr32 = ADDI32 [[ADDI32_1]], 4
; PREGREEDY-NEXT:   PseudoLoopEnd %bb.4
...
; PREGREEDY-NEXT:   B %bb.7
; PREGREEDY-NEXT: {{  $}}
; PREGREEDY-NEXT: bb.7.exit:
; PREGREEDY-NEXT:   $r1 = COPY [[LOADI32_]]
; PREGREEDY-NEXT:   RET implicit $r15, implicit $r1, implicit $r15
;
; PREPOST-LABEL: name: qor_dual_load_mac_stream
; PREPOST: bb.0.entry:
; PREPOST-NEXT:   successors: %bb.1(0x50000000), %bb.6(0x30000000)
; PREPOST-NEXT:   liveins: $r1, $r2, $r3, $r0
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT:   $r0 = frame-setup XOR32 $r0, $r0
; PREPOST-NEXT:   $r13 = frame-setup SUBI32 $r13, 16
; PREPOST-NEXT:   frame-setup CFI_INSTRUCTION def_cfa_offset 16
; PREPOST-NEXT:   $r4 = MOVE32 $r1
; PREPOST-NEXT:   $r1 = ADDI32_W $r0, 0
; PREPOST-NEXT:   $r5 = SLT32 $r1, $r3
; PREPOST-NEXT:   $r5 = XORI32 killed $r5, 1
; PREPOST-NEXT:   BNEZ_W $r5, %bb.6
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.1.loop.preheader:
; PREPOST-NEXT:   successors: %bb.3(0x40000000), %bb.5(0x40000000)
...
; PREPOST-NEXT:   BNEZ_W $r6, %bb.5
; PREPOST-NEXT:   B %bb.3
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.2.loop:
; PREPOST-NEXT:   successors: %bb.2(0x7c000000), %bb.4(0x04000000)
; PREPOST-NEXT:   liveins: $r1, $r2, $r4, $r5, $r6, $r7
; PREPOST-NEXT: {{  $}}
...
; PREPOST-NEXT:   B %bb.4
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.3.loop:
; PREPOST-NEXT:   successors: %bb.2(0x40000000), %bb.4(0x40000000)
; PREPOST-NEXT:   liveins: $r1, $r2, $r3, $r4, $r5, $r7
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT:   $r6 = MULL killed $r5, killed $r4
...
; PREPOST-NEXT:   BEQZ_W $r3, %bb.2
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.4:
; PREPOST-NEXT:   successors: %bb.5(0x80000000)
; PREPOST-NEXT:   liveins: $r1, $r4, $r5, $r6
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT:   $r1 = ADD32 killed $r1, killed $r6
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.5:
; PREPOST-NEXT:   successors: %bb.6(0x80000000)
; PREPOST-NEXT:   liveins: $r1, $r4, $r5
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT:   $r2 = MULL killed $r5, killed $r4
; PREPOST-NEXT:   $r1 = ADD32 killed $r1, killed $r2
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT: bb.6.exit:
; PREPOST-NEXT:   liveins: $r1
; PREPOST-NEXT: {{  $}}
; PREPOST-NEXT:   $r13 = frame-destroy ADDI32_W $r13, 16
; PREPOST-NEXT:   frame-destroy CFI_INSTRUCTION def_cfa $r13, 0
; PREPOST-NEXT:   $r0 = JALR_W $r15, 0, implicit $r1
;
; POST-LABEL: name: qor_dual_load_mac_stream
; POST: bb.0.entry:
; POST-NEXT:   successors: %bb.1(0x50000000), %bb.6(0x30000000)
; POST-NEXT:   liveins: $r1, $r2, $r3, $r0
; POST-NEXT: {{  $}}
; POST-NEXT:   frame-setup BUNDLE 0, 0, implicit-def $r13, implicit-def $r0, implicit $r13, implicit $r0 {
; POST-NEXT:     $r13 = frame-setup SUBI32_E2_E1_ALU1_RI20 $r13, 16
; POST-NEXT:     $r0 = frame-setup XOR32_E2_E0_ALU0_RR $r0, $r0
; POST-NEXT:   }
; POST-NEXT:   frame-setup CFI_INSTRUCTION def_cfa_offset 16
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r4, implicit killed $r1 {
; POST-NEXT:     $r4 = MOVE32_E2_E0_ALU0_R killed $r1
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r1, implicit $r0 {
; POST-NEXT:     $r1 = ADDI32_E2_E0_ALU0_RI20 $r0, 0
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r5, implicit $r1, implicit $r3 {
; POST-NEXT:     $r5 = SLT32_E2_E0_ALU0_RR $r1, $r3
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r5, implicit killed $r5 {
; POST-NEXT:     $r5 = XORI32_E2_E1_ALU1_RI20 killed $r5, 1
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit killed $r5 {
; POST-NEXT:     BNEZ_E2_E0_ALU0_I12 killed $r5, %bb.6
; POST-NEXT:   }
; POST-NEXT: {{  $}}
; POST-NEXT: bb.1.loop.preheader:
; POST-NEXT:   successors: %bb.3(0x40000000), %bb.5(0x40000000)
; POST-NEXT:   liveins: $r1, $r2, $r3, $r4
; POST-NEXT: {{  $}}
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r5, implicit-def $r6, implicit $r3, implicit $r0 {
; POST-NEXT:     $r5 = ADDI32_E2_E1_ALU1_RI20 $r3, -2
; POST-NEXT:     $r6 = ADDI32_E2_E0_ALU0_RI20 $r0, 2
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit killed $r5 {
; POST-NEXT:     SET_HWLOOP_F2_E2_E0_ALU0_HWLRIIR 0, %bb.2, %bb.2, killed $r5
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r5, implicit-def $r6, implicit $r4, implicit $r3, implicit killed $r6 :: (load (s32) from %ir.lsr.iv1) {
; POST-NEXT:     $r5 = S_LW_WITH_IMM_E2_E1_LOAD1_RI6 $r4, 0 :: (load (s32) from %ir.lsr.iv1)
; POST-NEXT:     $r6 = SLT32_E2_E0_ALU0_RR $r3, killed $r6
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r7, implicit killed $r4 {
; POST-NEXT:     $r7 = ADDI32_E2_E1_ALU1_RI20 killed $r4, 4
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 1, 0, implicit-def $r4, implicit-def $r2, implicit killed $r2 :: (load (s32) from %ir.lsr.iv) {
; POST-NEXT:     $r4, $r2 = S_LW_POST_IMM_E3_E2_LOAD1_RI6 killed $r2, 1 :: (load (s32) from %ir.lsr.iv)
; POST-NEXT:     NOP
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit killed $r6 {
; POST-NEXT:     BNEZ_E2_E0_ALU0_I12 killed $r6, %bb.5
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0 {
; POST-NEXT:     B %bb.3
; POST-NEXT:   }
; POST-NEXT: {{  $}}
; POST-NEXT: bb.2.loop:
; POST-NEXT:   successors: %bb.2(0x7c000000), %bb.4(0x04000000)
; POST-NEXT:   liveins: $r1, $r2, $r4, $r5, $r6, $r7
; POST-NEXT: {{  $}}
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r1, implicit killed $r1, implicit killed $r6 {
; POST-NEXT:     $r1 = ADD32_E2_E0_ALU0_RR killed $r1, killed $r6
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r6, implicit killed $r5, implicit killed $r4 {
; POST-NEXT:     $r6 = MULL_E2_E1_MAC1_RR killed $r5, killed $r4
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r5, implicit-def $r7, implicit killed $r7 :: (load (s32) from %ir.lsr.iv1 + 8) {
; POST-NEXT:     $r5 = S_LW_WITH_IMM_E2_E1_LOAD1_RI6 $r7, 0 :: (load (s32) from %ir.lsr.iv1 + 8)
; POST-NEXT:     $r7 = ADDI32_E2_E0_ALU0_RI20 killed $r7, 4
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 1, 0, implicit-def $r4, implicit-def $r2, implicit killed $r2 :: (load (s32) from %ir.lsr.iv + 8) {
; POST-NEXT:     $r4, $r2 = S_LW_POST_IMM_E3_E2_LOAD1_RI6 killed $r2, 1 :: (load (s32) from %ir.lsr.iv + 8)
; POST-NEXT:     NOP
; POST-NEXT:   }
...
; POST-NEXT: {{  $}}
; POST-NEXT: bb.3.loop:
; POST-NEXT:   successors: %bb.2(0x40000000), %bb.4(0x40000000)
; POST-NEXT:   liveins: $r1, $r2, $r3, $r4, $r5, $r7
; POST-NEXT: {{  $}}
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r6, implicit-def $r5, implicit killed $r5, implicit killed $r4, implicit $r7 :: (load (s32) from %ir.lsr.iv1 + 4) {
; POST-NEXT:     $r6 = MULL_E2_E1_MAC1_RR killed $r5, killed $r4
; POST-NEXT:     $r5 = S_LW_WITH_IMM_E2_E0_LOADSTORE0_RI6 $r7, 0 :: (load (s32) from %ir.lsr.iv1 + 4)
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r4, implicit $r0 {
; POST-NEXT:     $r4 = ADDI32_E2_E0_ALU0_RI20 $r0, 3
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r7, implicit-def $r3, implicit killed $r7, implicit killed $r3, implicit killed $r4 {
; POST-NEXT:     $r7 = ADDI32_E2_E1_ALU1_RI20 killed $r7, 4
; POST-NEXT:     $r3 = SLT32_E2_E0_ALU0_RR killed $r3, killed $r4
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 1, 0, implicit-def $r4, implicit-def $r2, implicit killed $r2 :: (load (s32) from %ir.lsr.iv + 4) {
; POST-NEXT:     $r4, $r2 = S_LW_POST_IMM_E3_E2_LOAD1_RI6 killed $r2, 1 :: (load (s32) from %ir.lsr.iv + 4)
; POST-NEXT:     NOP
; POST-NEXT:   }
; POST-NEXT:   BUNDLE 0, 0, implicit killed $r3 {
; POST-NEXT:     BEQZ_E2_E0_ALU0_I12 killed $r3, %bb.2
; POST-NEXT:   }
; POST-NEXT: {{  $}}
; POST-NEXT: bb.4:
; POST-NEXT:   successors: %bb.5(0x80000000)
; POST-NEXT:   liveins: $r1, $r4, $r5, $r6
; POST-NEXT: {{  $}}
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r1, implicit killed $r1, implicit killed $r6 {
; POST-NEXT:     $r1 = ADD32_E2_E0_ALU0_RR killed $r1, killed $r6
; POST-NEXT:   }
; POST-NEXT: {{  $}}
; POST-NEXT: bb.5:
; POST-NEXT:   successors: %bb.6(0x80000000)
; POST-NEXT:   liveins: $r1, $r4, $r5
; POST-NEXT: {{  $}}
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r2, implicit killed $r5, implicit killed $r4 {
; POST-NEXT:     $r2 = MULL_E2_E1_MAC1_RR killed $r5, killed $r4
; POST-NEXT:   }
...
; POST-NEXT: {{  $}}
; POST-NEXT:   frame-destroy BUNDLE 0, 0, implicit-def $r13, implicit $r13 {
; POST-NEXT:     $r13 = frame-destroy ADDI32_E2_E0_ALU0_RI20 $r13, 16
; POST-NEXT:   }
; POST-NEXT:   frame-destroy CFI_INSTRUCTION def_cfa $r13, 0
; POST-NEXT:   BUNDLE 0, 0, implicit-def $r0, implicit $r15 {
; POST-NEXT:     $r0 = JALR_E2_E0_ALU0_RI12 $r15, 0, implicit killed $r1
