...
; CHECK-NEXT:    { nop; movt32 r6, r12, r3 }
...
; CHECK-NEXT:    { nop; ld32 r1, r1, 0 }
; CHECK-NEXT:    { nop; movt32 r6, r4, r7 }
...
; CHECK-NEXT:    { nop; movt32 r4, r5, r12 }
; CHECK-NEXT:    { nop; ld32 r4, r4, 0 }
; CHECK-NEXT:    { nop; movt32 r7, r6, r12 }
