...
; Role: object — tied-def accumulator MAC must encode/decode round-trip with acc and dst forced to the same physical register.
...
; MIR-LABEL: test_mula64_ll:
; MIR:       // %bb.0:
; MIR-NEXT:    { xor32 r0, r0, r0; nop }
; MIR-NEXT:    { subi32 sp, sp, 8; nop }
; MIR-NEXT:    .cfi_def_cfa_offset 8
; MIR-NEXT:    { mula64.ll d0, d1, d2; nop }
; MIR-NEXT:    { xor32 r0, r0, r0; nop }
; MIR-NEXT:    { addi32_w sp, sp, 8; nop }
; MIR-NEXT:    { jalr_w r0, lr, 0; nop }
...
; MIR-NEXT:    { subi32 sp, sp, 8; nop }
; MIR-NEXT:    .cfi_def_cfa_offset 8
; MIR-NEXT:    { muls64.ll d0, d1, d2; nop }
; MIR-NEXT:    { xor32 r0, r0, r0; nop }
; MIR-NEXT:    { addi32_w sp, sp, 8; nop }
; MIR-NEXT:    { jalr_w r0, lr, 0; nop }
...
; MIR-NEXT:    { subi32 sp, sp, 8; nop }
; MIR-NEXT:    .cfi_def_cfa_offset 8
; MIR-NEXT:    { ff2mula32rs.lh d0, d1, d2; nop }
; MIR-NEXT:    { xor32 r0, r0, r0; nop }
; MIR-NEXT:    { addi32_w sp, sp, 8; nop }
; MIR-NEXT:    { jalr_w r0, lr, 0; nop }
...
; MIR-NEXT:    { subi32 sp, sp, 8; nop }
; MIR-NEXT:    .cfi_def_cfa_offset 8
; MIR-NEXT:    { x2fcmula32rs d0, d1, d2; nop }
; MIR-NEXT:    { xor32 r0, r0, r0; nop }
; MIR-NEXT:    { addi32_w sp, sp, 8; nop }
; MIR-NEXT:    { jalr_w r0, lr, 0; nop }
