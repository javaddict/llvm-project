...
; RUN:   | FileCheck %s --check-prefix=ADDR
; REQUIRES: asserts
;
; TTI unroll↔SMS guard (AIE aie-prefer-swp-over-unroll analog) plus
; post-indexed addressing preference (Hexagon
...
; Defer must clear Partial/Runtime that BaseT may have set.
...
; ADDR-LABEL: memcpy_runtime:
; ADDR: jalr
; ADDR-LABEL: memcpy_const16:
; ADDR: jalr
; ADDR-LABEL: mac_const4:
; ADDR: jalr
; ADDR-LABEL: mac_const16:
; ADDR: jalr
