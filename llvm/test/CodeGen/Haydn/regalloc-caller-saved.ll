...
; CHECK-NEXT:    { addi32_w r4, sp, 8 }
; CHECK-NEXT:    { st32 lr, r4, 0 }
; CHECK-NEXT:    { st32 r10, r4, 4 }
; CHECK-NEXT:    { st32 r9, r4, 8 }
; CHECK-NEXT:    { st32 r8, r4, 12 }
; CHECK-NEXT:    { move32 r8, r1; move32 r9, r2; nop }
; CHECK-NEXT:    { move32 r10, r3 }
; CHECK-NEXT:    { jal_w lr, clobber_gpr }
; CHECK-NEXT:    { add32 r2, r8, r9; xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { add32 r2, r2, r10 }
; CHECK-NEXT:    { add32 r1, r2, r1 }
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { ld32 lr, sp, 8 }
; CHECK-NEXT:    { ld32 r10, sp, 12 }
; CHECK-NEXT:    { ld32 r9, sp, 16 }
...
; CHECK-NEXT:    { st32 lr, sp, 28 }
; CHECK-NEXT:    { addi32_w r1, sp, 8 }
; CHECK-NEXT:    { st64 d9, r1, 0 }
; CHECK-NEXT:    { st64 d8, r1, 8 }
; CHECK-NEXT:    { nop; or64 d8, d0, d0; or64 d9, d1, d1 }
; CHECK-NEXT:    { jal_w lr, clobber_dr64 }
...
; CHECK-NEXT:    { addi32_w r12, sp, 16 }
; CHECK-NEXT:    { st32 lr, r12, 0 }
; CHECK-NEXT:    { st32 fp, r12, 4 }
; CHECK-NEXT:    { st32 r11, r12, 8 }
; CHECK-NEXT:    { st32 r10, r12, 12 }
; CHECK-NEXT:    { st32 r9, r12, 16 }
; CHECK-NEXT:    { st32 r8, r12, 20 }
; CHECK-NEXT:    { st32 r1, sp, 12; move32 r9, r2; move32 r10, r3 } // 4-byte Folded Spill
; CHECK-NEXT:    { st32 r7, sp, 8; move32 r11, r4; move32 fp, r5 } // 4-byte Folded Spill
; CHECK-NEXT:    { move32 r8, r6 }
; CHECK-NEXT:    { jal_w lr, clobber_gpr }
...
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { subi32 sp, sp, 24 }
; CHECK-NEXT:    { addi32_w r2, sp, 16 }
; CHECK-NEXT:    { st32 lr, r2, 0 }
; CHECK-NEXT:    { st32 r8, r2, 4 }
; CHECK-NEXT:    { st64 d8, sp, 8 }
; CHECK-NEXT:    { move32 r8, r1; or64 d8, d0, d0; nop }
; CHECK-NEXT:    { jal_w lr, clobber_all }
; CHECK-NEXT:    { xor32 r0, r0, r0; sext32t64 d0, r8; nop }
; CHECK-NEXT:    { slli64 d0, d0, 32 }
; CHECK-NEXT:    { srli64 d0, d0, 32 }
; CHECK-NEXT:    { add64 d0, d8, d0 }
; CHECK-NEXT:    { xor32 r0, r0, r0 }
; CHECK-NEXT:    { ld64 d8, sp, 8 }
; CHECK-NEXT:    { ld32 lr, sp, 16 }
; CHECK-NEXT:    { ld32 r8, sp, 20 }
; CHECK-NEXT:    { addi32_w sp, sp, 24 }
; CHECK-NEXT:    { jalr_w r0, lr, 0 }
