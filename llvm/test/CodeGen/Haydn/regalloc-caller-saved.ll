...
; CHECK-NEXT:    { nop; nop; addi32_w r4, sp, 8 }
; CHECK-NEXT:    { nop; nop; st32 lr, r4, 0 }
; CHECK-NEXT:    { nop; nop; st32 r10, r4, 4 }
; CHECK-NEXT:    { nop; nop; st32 r9, r4, 8 }
; CHECK-NEXT:    { nop; nop; st32 r8, r4, 12 }
; CHECK-NEXT:    { move32 r8, r1; move32 r9, r2; nop }
; CHECK-NEXT:    { move32 r10, r3; nop; nop }
; CHECK-NEXT:    { nop; nop; jal_w lr, clobber_gpr }
...
; CHECK-NEXT:  // %bb.0: // %entry
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
; CHECK-NEXT:    { subi32 sp, sp, 32; nop; nop }
; CHECK-NEXT:    { nop; nop; st32 lr, sp, 28 }
; CHECK-NEXT:    { nop; nop; addi32_w r1, sp, 8 }
; CHECK-NEXT:    { nop; nop; st64 d9, r1, 0 }
; CHECK-NEXT:    { nop; nop; st64 d8, r1, 8 }
; CHECK-NEXT:    { or64 d8, d0, d0; or64 d9, d1, d1; nop }
; CHECK-NEXT:    { nop; nop; jal_w lr, clobber_dr64 }
...
; CHECK-NEXT:    { nop; nop; addi32_w r12, sp, 16 }
; CHECK-NEXT:    { nop; nop; st32 lr, r12, 0 }
; CHECK-NEXT:    { nop; nop; st32 fp, r12, 4 }
; CHECK-NEXT:    { nop; nop; st32 r11, r12, 8 }
; CHECK-NEXT:    { nop; nop; st32 r10, r12, 12 }
; CHECK-NEXT:    { nop; nop; st32 r9, r12, 16 }
; CHECK-NEXT:    { nop; nop; st32 r8, r12, 20 }
; CHECK-NEXT:    { move32 r9, r2; move32 r10, r3; st32 r1, sp, 12 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { move32 r11, r4; move32 fp, r5; st32 r7, sp, 8 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
...
; CHECK-NEXT:    { nop; nop; st32 r11, r2, 8 }
; CHECK-NEXT:    { nop; nop; st32 r10, r2, 12 }
; CHECK-NEXT:    { nop; nop; st32 r9, r2, 16 }
; CHECK-NEXT:    { nop; nop; st32 r8, r2, 20 }
...
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
; CHECK-NEXT:    { subi32 sp, sp, 24; nop; nop }
; CHECK-NEXT:    { nop; nop; addi32_w r2, sp, 16 }
; CHECK-NEXT:    { nop; nop; st32 lr, r2, 0 }
; CHECK-NEXT:    { nop; nop; st32 r8, r2, 4 }
; CHECK-NEXT:    { nop; nop; st64 d8, sp, 8 }
; CHECK-NEXT:    { move32 r8, r1; or64 d8, d0, d0; nop }
; CHECK-NEXT:    { nop; nop; jal_w lr, clobber_all }
; CHECK-NEXT:    { xor32 r0, r0, r0; sext32t64 d0, r8; nop }
