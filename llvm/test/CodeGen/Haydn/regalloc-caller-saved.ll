...
; CHECK-NEXT:    { nop; st32 lr, r4, 0 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r10, r4, 1 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r9, r4, 2 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r8, r4, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; move32 r9, r2; move32 r8, r1 }
; CHECK-NEXT:    { nop; lui r1, clobber_gpr }
; CHECK-NEXT:    { move32 r10, r3; addi32 r1, r1, clobber_gpr }
...
; CHECK-NEXT:    { ld32 r10, sp, 3; ld32 lr, sp, 2 }
...
; CHECK-NEXT:    { nop; st64 d9, r1, 0 } // 8-byte Folded Spill
; CHECK-NEXT:    // 8-byte Spill
; CHECK-NEXT:    { nop; st64 d8, r1, 1 } // 8-byte Folded Spill
; CHECK-NEXT:    // 8-byte Spill
; CHECK-NEXT:    { nop; lui r1, clobber_dr64 }
; CHECK-NEXT:    { nop; addi32 r1, r1, clobber_dr64 }
; CHECK-NEXT:    { nop; or64 d9, d1, d1; or64 d8, d0, d0 }
; CHECK-NEXT:    { jalr lr, r1, 0 }
; CHECK-NEXT:    { nop; add64 d1, d8, d9; xor32 r0, r0, r0 }
; CHECK-NEXT:    { add64 d0, d1, d0; xor32 r0, r0, r0; ld64 d9, sp, 1 }
...
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; lui r1, clobber_gpr }
; CHECK-NEXT:    { move32 r8, r6; addi32 r1, r1, clobber_gpr }
; CHECK-NEXT:    { jalr lr, r1, 0 }
; CHECK-NEXT:    { xor32 r0, r0, r0; ld32 r2, sp, 3 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { add32 r2, r2, r9; ld32 r3, sp, 2 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { nop; add32 r2, r2, r10 }
...
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r11, r2, 2 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r10, r2, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r9, r2, 4 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; st32 r8, r2, 5 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; lui r8, clobber_gpr }
; CHECK-NEXT:    { st32 r1, sp, 3; addi32 r8, r8, clobber_gpr } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
...
; CHECK-NEXT:    { jalr lr, r8, 0 }
; CHECK-NEXT:    { nop; xor32 r0, r0, r0; ld32 r2, sp, 3 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { nop; nop }
...
; CHECK-NEXT:    { ld64 d8, sp, 1; xor32 r0, r0, r0; add64 d0, d8, d0 }
; CHECK-NEXT:    { ld32 r8, sp, 5; ld32 lr, sp, 4 }
; CHECK-NEXT:    { nop; addi32 sp, sp, 24 }
; CHECK-NEXT:    { nop; jalr r0, lr, 0 }
entry:
