...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __divsi3
  %r = sdiv i32 %a, %b
  ret i32 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __udivsi3
  %r = udiv i32 %a, %b
  ret i32 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __modsi3
  %r = srem i32 %a, %b
  ret i32 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __umodsi3
  %r = urem i32 %a, %b
  ret i32 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __divdi3
  %r = sdiv i64 %a, %b
  ret i64 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __udivdi3
  %r = udiv i64 %a, %b
  ret i64 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __moddi3
  %r = srem i64 %a, %b
  ret i64 %r
}
...
; CHECK: jal{{(_[pP][23][0-9]_[A-Z0-9]+)?}} lr, __umoddi3
  %r = urem i64 %a, %b
  ret i64 %r
}
