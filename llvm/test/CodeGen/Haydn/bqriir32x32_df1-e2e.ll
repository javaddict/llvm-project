...
; RUN: llc -mtriple=haydn-unknown-elf -global-isel-abort=1 -verify-machineinstrs < %s | llvm-mc -triple=haydn-unknown-elf -filetype=obj -o %t.o && llvm-objdump -d %t.o | FileCheck --check-prefix=BUNDLE %s
