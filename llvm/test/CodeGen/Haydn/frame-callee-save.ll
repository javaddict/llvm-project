...
; CHECK-NEXT:    { xor32 r0, r0, r0; add32 r1, r1, r8 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
...
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 fp, r1; move32 r1, r9 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r9, r1; move32 r1, r10 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r10, r1; move32 r1, r11 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r11, r1; move32 r1, r8 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { add32 r2, fp, r9; xor32 r0, r0, r0 }
...
; CHECK-NEXT:    { jal_w lr, use_i64; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; add64 d1, d10, d8 }
...
; CHECK-NEXT:    { st32 lr, sp, 5; nop }
; CHECK-NEXT:    { st64 d8, sp, 1; nop }
; CHECK-NEXT:    .cfi_def_cfa_offset 24
; CHECK-NEXT:    .cfi_offset lr, 20
; CHECK-NEXT:    .cfi_offset d8, 8
; CHECK-NEXT:    { sext32t64 d8, r1; nop }
; CHECK-NEXT:    { jal_w lr, use_i64; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; add64 d0, d0, d8 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
...
; CHECK-NEXT:    { xor32 r0, r0, r0; add32 r1, r8, r9 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
...
; CHECK-NEXT:    { move32 r11, r2; move32 r8, r3; st32 r7, sp, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { move32 r9, r4; move32 fp, r5 }
; CHECK-NEXT:    { move32 r10, r6; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; st32 r1, sp, 2 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { move32 r1, r11; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r11, r1; move32 r1, r8 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r8, r1; move32 r1, r9 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r9, r1; move32 r1, fp }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 fp, r1; move32 r1, r10 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { move32 r10, r1; ld32 r1, sp, 3 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { jal_w lr, use_i32; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; ld32 r2, sp, 2 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { add32 r2, r2, r11; nop }
