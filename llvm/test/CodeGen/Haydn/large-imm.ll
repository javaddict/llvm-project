...
; CHECK-LABEL: lo16_bit15_set_1:                       // @lo16_bit15_set_1
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r1, 291 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r1, 306125 }
...
; CHECK-LABEL: hi_zero_lo_all_ones:                    // @hi_zero_lo_all_ones
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
...
; CHECK-LABEL: negative_lo_min:                        // @negative_lo_min
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
...
; CHECK-LABEL: lo16_just_above_bit15:                  // @lo16_just_above_bit15
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r1, 2749 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r1, -163839 }
; CHECK: 	{ 	jalr_w{{(\.s[012])?}}	r0, lr, 0 }
; CHECK: .Lfunc_end4:
...
; CHECK-LABEL: lo16_all_ones:                          // @lo16_all_ones
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r1, 3563 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r1, -131073 }
; CHECK: 	{ 	jalr_w{{(\.s[012])?}}	r0, lr, 0 }
; CHECK: .Lfunc_end5:
...
; CHECK-LABEL: lo_zero:                                // @lo_zero
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r1, 291 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r1, 262144 }
; CHECK: 	{ 	jalr_w{{(\.s[012])?}}	r0, lr, 0 }
; CHECK: .Lfunc_end6:
...
; CHECK-LABEL: lo16_no_bit15:                          // @lo16_no_bit15
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r1, 291 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r1, 266804 }
; CHECK: 	{ 	jalr_w{{(\.s[012])?}}	r0, lr, 0 }
; CHECK: .Lfunc_end7:
...
; CHECK-LABEL: max_simm16:                             // @max_simm16
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
...
; CHECK-LABEL: small_pos:                              // @small_pos
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
...
; CHECK-LABEL: small_neg:                              // @small_neg
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r0, -42 }
...
; CHECK-LABEL: min_simm16:                             // @min_simm16
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	addi32{{(_w)?}}	r1, r0, -32768 }
...
; CHECK-LABEL: add_with_lo16_bit15:                    // @add_with_lo16_bit15
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r2, 291 }
; CHECK: 	{ 	addi32{{(_w)?}}	r2, r2, 306125 }
...
; CHECK-LABEL: cmp_with_int_max:                       // @cmp_with_int_max
; CHECK: 	.cfi_startproc
; CHECK: // %bb.0:
; CHECK: 	{ 	xor32	r0, r0, r0 }
; CHECK: 	{ 	lui	r2, 2048 }
; CHECK: 	{ 	addi32{{(_w)?}}	r2, r2, -1 }
