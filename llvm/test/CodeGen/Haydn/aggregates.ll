...
; CHECK-NEXT:    { addi32 r2, r0, 99; addi32 r1, r0, 42 }
...
; CHECK-NEXT:    { nop; lui r3, sum_array_arg }
; CHECK-NEXT:    { addi32 r2, r0, 20; addi32 r1, r0, 10 }
; CHECK-NEXT:    { nop; addi32 r3, r3, sum_array_arg }
...
; CHECK-NEXT:    { addi32 r4, r0, 42; addi32 r3, r2, 4 }
...
; CHECK-NEXT:    { slli64 d0, d0, 32; addi32 r1, r1, 8 }
; CHECK-NEXT:    { nop; nop; srli64 d0, d0, 32 }
; CHECK-NEXT:    { d_sw_l_with_imm d0, r1, 0; addi32 r3, r1, 4 }
; CHECK-NEXT:    { nop; d_sw_h_with_imm d0, r3, 0 }
; CHECK-NEXT:    { nop; addi32 sp, sp, 8 }
; CHECK-NEXT:    .cfi_def_cfa sp, 0
; CHECK-NEXT:    { nop; jalr r0, lr, 0 }
