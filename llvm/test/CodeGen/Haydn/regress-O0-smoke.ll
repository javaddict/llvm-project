...
; CHECK-NEXT:    { nop; st32 r2, sp, 5; slt32 r1, r2, r1 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
...
; CHECK-NEXT:    // 4-byte Reload4-byte Reload
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { nop; nop; sub32 r1, r1, r2 }
; CHECK-NEXT:    { nop; st32 r1, sp, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; beqz r0, .LBB6_3 }
...
; CHECK-NEXT:    { ld32 r4, sp, 4; ld32 r1, sp, 3 } // 8-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload4-byte Reload
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { ld32 r2, sp, 5; addi32 r3, r4, 1 } // 4-byte Folded Reload
; CHECK-NEXT:    // 4-byte Reload
; CHECK-NEXT:    { nop; nop }
...
; CHECK-NEXT:    { nop; lui r2, ext_1arg }
; CHECK-NEXT:    { nop; addi32 r2, r2, ext_1arg }
...
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset lr, -4
; CHECK-NEXT:    { nop; lui r4, ext_3args }
; CHECK-NEXT:    { nop; addi32 r4, r4, ext_3args }
...
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset lr, -4
; CHECK-NEXT:    { nop; lui r12, ext_7args }
; CHECK-NEXT:    { nop; addi32 r12, r12, ext_7args }
; CHECK-NEXT:    { jalr lr, r12, 0 }
; CHECK-NEXT:    { xor32 r0, r0, r0; ld32 lr, sp, 3 }
; CHECK-NEXT:    { nop; addi32 sp, sp, 16 }
; CHECK-NEXT:    .cfi_def_cfa sp, 0
; CHECK-NEXT:    { nop; jalr r0, lr, 0 }
...
; CHECK-NEXT:    { addi32 r10, r0, 8; addi32 r7, r0, 7 }
; CHECK-NEXT:    { nop; subi32 sp, sp, 16 }
; CHECK-NEXT:    { nop; lui r12, ext_9args }
; CHECK-NEXT:    { move32 r9, sp; addi32 r12, r12, ext_9args }
; CHECK-NEXT:    { nop; st32 r10, r9, 0 }
; CHECK-NEXT:    { nop; st32 r8, r9, 2 }
; CHECK-NEXT:    { jalr lr, r12, 0 }
