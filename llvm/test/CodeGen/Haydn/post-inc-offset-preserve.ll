...
; CHECK-NEXT:    { sext32t64 d1, r4; nop }
...
; CHECK-NEXT:    { x2srai32 d2, d0, 16; x2slli32 d4, d0, 16; ld32 r12, r1, 0 }
; CHECK-NEXT:    { addi32_w r6, r1, 4; nop }
; CHECK-NEXT:    { x2slli32 d2, d2, 16; ld32 r6, r6, 0; st32 r12, sp, 2 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { x2srai32 d4, d4, 16; x2srai32 d2, d2, 16; st32 r6, sp, 3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { or64 d5, d1, d1; x2slli32 d2, d2, 16; ld64 d3, sp, 1 } // 8-byte Folded Reload
; CHECK-NEXT:    // 8-byte Reload
; CHECK-NEXT:    { x2srai32 d2, d2, 16; add32 r5, r5, r4; addi32 r1, r1, 8 }
; CHECK-NEXT:    { fmula16.ls00 d5, d3, d4; slt32 r6, r5, r3 }
; CHECK-NEXT:    { fmula16.ls11 d5, d3, d4; nop }
; CHECK-NEXT:    { fmula16.hs00 d5, d3, d2; nop }
; CHECK-NEXT:    { fmula16.hs11 d5, d3, d2; nop }
; CHECK-NEXT:    { addi32_w r7, r2, 4; nop }
; CHECK-NEXT:    { d_sw_l_with_imm d5, r2, 0; nop }
; CHECK-NEXT:    { addi32_w r2, r2, 8; nop }
; CHECK-NEXT:    { d_sw_h_with_imm d5, r7, 0; nop }
...
; CHECK-NEXT:    { sext32t64 d2, r3; nop }
...
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    { x2srai32 d3, d1, 16; x2slli32 d4, d1, 16; add32 r4, r4, r3 }
; CHECK-NEXT:    { x2slli32 d3, d3, 16; x2srai32 d4, d4, 16; slt32 r6, r4, r2 }
...
; CHECK-NEXT:    { fmula16.hs00 d5, d0, d3; nop }
; CHECK-NEXT:    { fmula16.hs11 d5, d0, d3; nop }
; CHECK-NEXT:    { addi32_w r5, r1, 4; nop }
; CHECK-NEXT:    { d_sw_l_with_imm d5, r1, 0; nop }
; CHECK-NEXT:    { addi32_w r1, r1, 8; nop }
; CHECK-NEXT:    { d_sw_h_with_imm d5, r5, 0; nop }
