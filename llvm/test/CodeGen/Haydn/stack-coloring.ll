...
; CHECK-NEXT:    { jal_w lr, use_pair; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
...
; CHECK-NEXT:    { addi32_w r2, sp, 12; nop }
; CHECK-NEXT:    { ld32 r1, r1, 0; nop }
; CHECK-NEXT:    { addi32_w r4, r0, 20; nop }
; CHECK-NEXT:    { st32 r4, r2, 0; nop }
; CHECK-NEXT:    { addi32_w r3, sp, 8; nop }
; CHECK-NEXT:    { ld32 r2, r2, 0; nop }
; CHECK-NEXT:    { addi32_w r4, r0, 30; nop }
; CHECK-NEXT:    { add32 r1, r1, r2; st32 r4, r3, 0 }
; CHECK-NEXT:    { ld32 r3, r3, 0; nop }
...
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { add32 r5, r3, r5; add32 r3, r3, r4 }
; CHECK-NEXT:    { slt32 r6, r3, r1; st32 r5, r2, 0 }
...
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { addi32_w r1, sp, 16; nop }
; CHECK-NEXT:    { addi32_w r3, r0, 100; nop }
; CHECK-NEXT:    { st32 r3, r1, 0; nop }
; CHECK-NEXT:    { addi32_w r2, sp, 12; nop }
; CHECK-NEXT:    { ld32 r1, r1, 0; nop }
; CHECK-NEXT:    { addi32_w r3, r0, 200; nop }
; CHECK-NEXT:    { st32 r3, r2, 0; nop }
; CHECK-NEXT:    { ld32 r2, r2, 0; nop }
...
; CHECK-NEXT:    { st32 r2, r1, 7; nop }
; CHECK-NEXT:    { ld32 r2, r1, 0; ld32 r1, r1, 7 }
; CHECK-NEXT:    { nop; nop }
...
; CHECK-NEXT:    { and32 r3, r1, r2; nop }
; CHECK-NEXT:    { addi32_w r1, sp, 12; nop }
; CHECK-NEXT:    { beqz_w r3, .LBB5_2; nop }
; CHECK-NEXT:  // %bb.1: // %f
; CHECK-NEXT:    { addi32_w r2, r0, 2; nop }
; CHECK-NEXT:  .LBB5_2: // %join
; CHECK-NEXT:    { st32 r2, r1, 0; nop }
; CHECK-NEXT:    { ld32 r1, r1, 0; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 16; nop }
...
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { lui r3, 12; nop }
; CHECK-NEXT:    { addi32_w r3, r3, -237234; nop }
; CHECK-NEXT:    { sext32t64 d0, r3; nop }
