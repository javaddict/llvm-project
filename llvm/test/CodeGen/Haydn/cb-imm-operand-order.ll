...
; CHECK-NEXT:    { d_ldw_cb_imm 0, d0, r1, 1; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
...
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
; CHECK-NEXT:    { d_ldw_cb_imm 1, d0, r1, 2; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 8; nop }
; CHECK-NEXT:    { jalr_w r0, lr, 0; nop }
...
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
; CHECK-NEXT:    { d_sdw_cb_imm 0, d0, r1, 1; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 8; nop }
; CHECK-NEXT:    { jalr_w r0, lr, 0; nop }
...
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { addi32_w r2, r0, 4096; nop }
; CHECK-NEXT:    { addi32_w r3, r0, 4351; nop }
; CHECK-NEXT:    { csrw_w 44, r2; nop }
; CHECK-NEXT:    { csrw_w 45, r3; nop }
; CHECK-NEXT:    { d_sdw_cb_imm 0, d0, r1, 1; nop }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop }
; CHECK-NEXT:    { addi32_w sp, sp, 8; nop }
; CHECK-NEXT:    { jalr_w r0, lr, 0; nop }
