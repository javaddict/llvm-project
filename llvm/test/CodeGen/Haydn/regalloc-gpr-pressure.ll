...
; CHECK-NEXT:    { nop; addi32_w r12, sp, 24 }
...
; CHECK-NEXT:    { st32 r2, sp, 5; move32 r11, r5; move32 r8, r1 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { st32 r3, sp, 4; addi32 r9, r8, 100 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { st32 r4, sp, 3; move32 fp, r6; move32 r1, r9 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
...
; CHECK-NEXT:    { nop; jal_w lr, consume_i32 }
