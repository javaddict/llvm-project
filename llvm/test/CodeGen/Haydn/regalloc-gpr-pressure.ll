...
; CHECK-NEXT:    { nop; lui r2, use_i32 }
; CHECK-NEXT:    { nop; xor32 r0, r0, r0; move32 r1, r10 }
; CHECK-NEXT:    { nop; addi32 r2, r2, use_i32 }
; CHECK-NEXT:    { jalr lr, r2, 0 }
...
; CHECK-NEXT:    // 4-byte Reload4-byte Reload
; CHECK-NEXT:    { nop; xor32 r0, r0, r0; add32 r1, r2, r9 }
...
; CHECK-NEXT:    { xor32 r0, r0, r0; addi32 r1, r1, 2112 }
...
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; lui r11, consume_i32 }
; CHECK-NEXT:    { st32 r5, sp, 3; move32 r8, r2; move32 r9, r3 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { move32 r10, r4; addi32 r11, r11, consume_i32 }
...
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; lui r10, consume_i32 }
; CHECK-NEXT:    { nop; addi32 r10, r10, consume_i32 }
