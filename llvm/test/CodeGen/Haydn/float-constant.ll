...
; CHECK: 	{ 		nop; 	nop; 	subi32	sp, sp, 8 }
; CHECK: 	.cfi_def_cfa_offset 8
; CHECK: 	{ 		lui	r1, 1311; 	nop; 	subi32	sp, sp, 8 }
; CHECK: 	{ 		addi32_w	r1, r1, -293601; 	nop; 	nop }
; CHECK: 	{ 		st32	r1, sp, 0; 	nop; 	nop }
; CHECK: 	{ 		nop; 	nop; 	nop }
; CHECK: 	{ 		lui	r1, 1025; 	nop; 	nop }
; CHECK: 	{ 		addi32_w	r1, r1, -450888; 	nop; 	nop }
; CHECK: 	{ 		st32	r1, sp, 4; 	nop; 	nop }
...
; CHECK: 	{ 		nop; 	nop; 	subi32	sp, sp, 8 }
; CHECK: 	.cfi_def_cfa_offset 8
; CHECK: 	{ 		addi32_w	r1, r0, 0; 	nop; 	subi32	sp, sp, 8 }
; CHECK: 	{ 		st32	r1, sp, 0; 	nop; 	nop }
; CHECK: 	{ 		nop; 	nop; 	nop }
; CHECK: 	{ 		lui	r1, 1023; 	nop; 	nop }
; CHECK: 	{ 		addi32_w	r1, r1, 0; 	nop; 	nop }
; CHECK: 	{ 		st32	r1, sp, 4; 	nop; 	nop }
; CHECK: 	{ 		addi32_w	sp, sp, 8; 	ld64	d0, sp, 0; 	nop }
; CHECK: 	{ 		nop; 	nop; 	xor32	r0, r0, r0 }
...
; CHECK: 	{ 		lui	r2, 1026; 	nop; 	nop }
; CHECK: 	{ 		addi32_w	r2, r2, 0; 	nop; 	nop }
; CHECK: 	{ 		jal_w	lr, __addsf3; 	nop; 	nop }
; CHECK: 	{ 		nop; 	nop; 	xor32	r0, r0, r0 }
