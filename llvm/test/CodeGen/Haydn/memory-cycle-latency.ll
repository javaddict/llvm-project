...
; PACK-PRODUCT-NEXT:    { xor32 r0, r0, r0; subi32 sp, sp, 8 }
...
; PACK-PRODUCT-NEXT:    { nop; jalr r0, lr, 0 }
;
; PACK-SOFT-LABEL: store_then_load:
; PACK-SOFT:       // %bb.0: // %entry
; PACK-SOFT-NEXT:    { xor32 r0, r0, r0; subi32 sp, sp, 8 }
...
; PACK-SOFT-NEXT:    { nop; jalr r0, lr, 0 }
entry:
...
; PACK-PRODUCT-NEXT:    { nop; st32 r2, r1, 0 }
; PACK-PRODUCT-NEXT:    { nop; nop }
; PACK-PRODUCT-NEXT:    { st32 r3, r1, 1; ld32 r2, r1, 0 }
; PACK-PRODUCT-NEXT:    { nop; nop }
; PACK-PRODUCT-NEXT:    { nop; nop; move32 r1, r2 }
; PACK-PRODUCT-NEXT:    { nop; addi32 sp, sp, 8 }
; PACK-PRODUCT-NEXT:    .cfi_def_cfa sp, 0
; PACK-PRODUCT-NEXT:    { nop; jalr r0, lr, 0 }
;
...
; PACK-SOFT-NEXT:    { nop; nop }
; PACK-SOFT-NEXT:    { nop; nop; move32 r1, r2 }
; PACK-SOFT-NEXT:    { nop; addi32 sp, sp, 8 }
; PACK-SOFT-NEXT:    .cfi_def_cfa sp, 0
; PACK-SOFT-NEXT:    { nop; jalr r0, lr, 0 }
entry:
