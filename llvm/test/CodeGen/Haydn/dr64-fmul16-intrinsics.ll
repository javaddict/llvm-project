...
define i64 @test_fmulaa16_hs_13_02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulaa16_hs_13_02:
; CHECK: fmulaa16_hs_13_02
  %bc.39 = bitcast i64 %a to <4 x i16>
  %bc.40 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulaa16.hs.13.02(i64 %acc, <4 x i16> %bc.39, <4 x i16> %bc.40)
  ret i64 %r
}
...
define i64 @test_fmulaa16_ls_11_00(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulaa16_ls_11_00:
; CHECK: fmulaa16_ls_11_00
  %bc.43 = bitcast i64 %a to <4 x i16>
  %bc.44 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulaa16.ls.11.00(i64 %acc, <4 x i16> %bc.43, <4 x i16> %bc.44)
  ret i64 %r
}

define i64 @test_fmulaa16_ls_13_02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulaa16_ls_13_02:
; CHECK: fmulaa16_ls_13_02
  %bc.45 = bitcast i64 %a to <4 x i16>
  %bc.46 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulaa16.ls.13.02(i64 %acc, <4 x i16> %bc.45, <4 x i16> %bc.46)
  ret i64 %r
}

define i64 @test_fmulaa16_ls_33_22(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulaa16_ls_33_22:
; CHECK: fmulaa16_ls_33_22
  %bc.47 = bitcast i64 %a to <4 x i16>
  %bc.48 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulaa16.ls.33.22(i64 %acc, <4 x i16> %bc.47, <4 x i16> %bc.48)
  ret i64 %r
}
...
define i64 @test_fmulss16_hs_13_02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulss16_hs_13_02:
; CHECK: fmulss16_hs_13_02
  %bc.49 = bitcast i64 %a to <4 x i16>
  %bc.50 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulss16.hs.13.02(i64 %acc, <4 x i16> %bc.49, <4 x i16> %bc.50)
  ret i64 %r
}

define i64 @test_fmulss16_hs_33_22(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulss16_hs_33_22:
; CHECK: fmulss16_hs_33_22
  %bc.51 = bitcast i64 %a to <4 x i16>
  %bc.52 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulss16.hs.33.22(i64 %acc, <4 x i16> %bc.51, <4 x i16> %bc.52)
  ret i64 %r
}

define i64 @test_fmulss16_ls_11_00(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulss16_ls_11_00:
; CHECK: fmulss16_ls_11_00
  %bc.53 = bitcast i64 %a to <4 x i16>
  %bc.54 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulss16.ls.11.00(i64 %acc, <4 x i16> %bc.53, <4 x i16> %bc.54)
  ret i64 %r
}

define i64 @test_fmulss16_ls_13_02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulss16_ls_13_02:
; CHECK: fmulss16_ls_13_02
  %bc.55 = bitcast i64 %a to <4 x i16>
  %bc.56 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulss16.ls.13.02(i64 %acc, <4 x i16> %bc.55, <4 x i16> %bc.56)
  ret i64 %r
}

define i64 @test_fmulss16_ls_33_22(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmulss16_ls_33_22:
; CHECK: fmulss16_ls_33_22
  %bc.57 = bitcast i64 %a to <4 x i16>
  %bc.58 = bitcast i64 %b to <4 x i16>
  %r = call i64 @llvm.haydn.fmulss16.ls.33.22(i64 %acc, <4 x i16> %bc.57, <4 x i16> %bc.58)
  ret i64 %r
}
...
define i64 @test_fmuls16_hs00(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs00:
; CHECK: fmuls16_hs00
  %r = call i64 @llvm.haydn.fmuls16.hs00(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs01(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs01:
; CHECK: fmuls16_hs01
  %r = call i64 @llvm.haydn.fmuls16.hs01(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs02:
; CHECK: fmuls16_hs02
  %r = call i64 @llvm.haydn.fmuls16.hs02(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs03(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs03:
; CHECK: fmuls16_hs03
  %r = call i64 @llvm.haydn.fmuls16.hs03(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs11(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs11:
; CHECK: fmuls16_hs11
  %r = call i64 @llvm.haydn.fmuls16.hs11(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs12(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs12:
; CHECK: fmuls16_hs12
  %r = call i64 @llvm.haydn.fmuls16.hs12(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs13(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs13:
; CHECK: fmuls16_hs13
  %r = call i64 @llvm.haydn.fmuls16.hs13(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs22(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs22:
; CHECK: fmuls16_hs22
  %r = call i64 @llvm.haydn.fmuls16.hs22(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs23(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs23:
; CHECK: fmuls16_hs23
  %r = call i64 @llvm.haydn.fmuls16.hs23(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_hs33(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_hs33:
; CHECK: fmuls16_hs33
  %r = call i64 @llvm.haydn.fmuls16.hs33(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}
...
define i64 @test_fmuls16_ls00(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls00:
; CHECK: fmuls16_ls00
  %r = call i64 @llvm.haydn.fmuls16.ls00(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls01(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls01:
; CHECK: fmuls16_ls01
  %r = call i64 @llvm.haydn.fmuls16.ls01(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls02(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls02:
; CHECK: fmuls16_ls02
  %r = call i64 @llvm.haydn.fmuls16.ls02(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls03(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls03:
; CHECK: fmuls16_ls03
  %r = call i64 @llvm.haydn.fmuls16.ls03(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls11(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls11:
; CHECK: fmuls16_ls11
  %r = call i64 @llvm.haydn.fmuls16.ls11(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls12(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls12:
; CHECK: fmuls16_ls12
  %r = call i64 @llvm.haydn.fmuls16.ls12(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls13(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls13:
; CHECK: fmuls16_ls13
  %r = call i64 @llvm.haydn.fmuls16.ls13(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls22(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls22:
; CHECK: fmuls16_ls22
  %r = call i64 @llvm.haydn.fmuls16.ls22(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls23(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls23:
; CHECK: fmuls16_ls23
  %r = call i64 @llvm.haydn.fmuls16.ls23(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}

define i64 @test_fmuls16_ls33(i64 %a, i64 %b, i64 %acc) {
; CHECK-LABEL: test_fmuls16_ls33:
; CHECK: fmuls16_ls33
  %r = call i64 @llvm.haydn.fmuls16.ls33(i64 %acc, i64 %a, i64 %b)
  ret i64 %r
}
