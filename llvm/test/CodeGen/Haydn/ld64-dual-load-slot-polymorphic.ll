...
; CHECK-NEXT:    { nop; xor32 r0, r0, r0 }
; CHECK-NEXT:    { nop; subi32 sp, sp, 24 }
; CHECK-NEXT:    { addi32 r5, r1, 8; ld32 r4, r1, 0 }
; CHECK-NEXT:    { nop; addi32 r3, r1, 4 }
; CHECK-NEXT:    { st32 r4, sp, 2; ld32 r3, r3, 0 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; nop }
; CHECK-NEXT:    { st32 r3, sp, 3; addi32 r1, r1, 16 } // 4-byte Folded Spill
; CHECK-NEXT:    // 4-byte Spill
; CHECK-NEXT:    { nop; addi32 r6, r5, 4 }
; CHECK-NEXT:    { ld32 r3, r5, 0; ld64 d0, sp, 1 } // 8-byte Folded Reload
; CHECK-NEXT:    // 8-byte Reload
; CHECK-NEXT:    { nop; ld32 r4, r6, 0 }
