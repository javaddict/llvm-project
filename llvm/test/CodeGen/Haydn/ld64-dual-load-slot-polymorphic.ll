...
; CHECK-NEXT:    { s_lw_with_imm r4, r1, 0; addi32 r3, r1, 4 }
; CHECK-NEXT:    { addi32 r1, r1, 8; s_lw_with_imm r3, r3, 0 }
; CHECK-NEXT:    { addi32 r5, r1, 4; s_lw_with_imm r1, r1, 0 }
; CHECK-NEXT:    { s_lw_with_imm r5, r5, 0; subi32 sp, sp, 8 }
...
; CHECK-NEXT:    { addi32 r1, r2, 4; s_sw_with_imm r5, sp, 1 }
; CHECK-NEXT:    { d_ldw_with_imm d1, sp, 0; addi32 sp, sp, 8 }
; CHECK-NEXT:    { nop; nop; nop }
; CHECK-NEXT:    { add64 d0, d0, d1; nop; nop }
; CHECK-NEXT:    { nop; nop; d_sw_l_with_imm d0, r2, 0 }
; CHECK-NEXT:    { nop; nop; d_sw_h_with_imm d0, r1, 0 }
; CHECK-NEXT:    { xor32 r0, r0, r0; nop; nop }
...
; CHECK-NEXT:    { s_lw_with_imm r4, r1, 0; addi32 r6, r5, 4 }
; CHECK-NEXT:    { s_lw_with_imm r3, r3, 0; nop; s_lw_with_imm r5, r5, 0 }
; CHECK-NEXT:    { addi32 r1, r1, 16; s_lw_with_imm r6, r6, 0 }
; CHECK-NEXT:    { addi32 r7, r1, 4; s_lw_with_imm r1, r1, 0 }
; CHECK-NEXT:    { s_lw_with_imm r7, r7, 0; subi32 sp, sp, 8 }
; CHECK-NEXT:    { nop; nop; s_sw_with_imm r4, sp, 0 }
; CHECK-NEXT:    { nop; nop; s_sw_with_imm r3, sp, 1 }
; CHECK-NEXT:    { d_ldw_with_imm d0, sp, 0; addi32 sp, sp, 8 }
; CHECK-NEXT:    { subi32 sp, sp, 8; nop }
...
; CHECK-NEXT:    { nop; nop; s_sw_with_imm r1, sp, 0 }
; CHECK-NEXT:    { addi32 r1, r2, 4; s_sw_with_imm r7, sp, 1 }
