...
; ASM-LABEL: sum_arr:
; ASM:       // #<spill-kpi> @sum_arr spills=0 spill-bytes=0 reloads=0 reload-bytes=0
; ASM-NEXT:  // %bb.0: // %entry
; ASM-NEXT:    { xor32 r0, r0, r0; nop; nop }
; ASM-NEXT:    { subi32 sp, sp, 8; nop }
; ASM-NEXT:    .cfi_def_cfa_offset 8
; ASM-NEXT:    { addi32 r3, r0, 0; addi32 r4, r0, 1 }
; ASM-NEXT:    { max32 r2, r2, r4; nop; nop }
...
; ASM-NEXT:    { s_lw_post_imm r2, r1, 1; nop; nop }
; ASM-NEXT:    { nop; nop; nop }
; ASM-NEXT:    .p2align 2
; ASM-NEXT:  .LLhwloop_end0:
; ASM-NEXT:    { add32 r3, r3, r2; nop; nop }
; ASM-NEXT:  // %bb.2: // %for.end
; ASM-NEXT:    { move32 r1, r3; nop; nop }
; ASM-NEXT:    { xor32 r0, r0, r0; nop; nop }
...
; ASM-LABEL: bigimm:
; ASM:       // #<spill-kpi> @bigimm spills=0 spill-bytes=0 reloads=0 reload-bytes=0
; ASM-NEXT:  // %bb.0: // %entry
; ASM-NEXT:    { xor32 r0, r0, r0; nop; nop }
; ASM-NEXT:    { subi32 sp, sp, 8; nop }
; ASM-NEXT:    .cfi_def_cfa_offset 8
; ASM-NEXT:    { addi32 r4, r0, 74565; addi32 r3, r0, 0 }
; ASM-NEXT:    { addi32 r5, r0, 1; nop }
; ASM-NEXT:    { max32 r2, r2, r5; nop; nop }
...
; ASM-NEXT:    { s_lw_post_imm r2, r1, 1; nop; nop }
; ASM-NEXT:    { nop; nop; nop }
; ASM-NEXT:    { mull r2, r2, r4; nop; nop }
; ASM-NEXT:    .p2align 2
...
; ASM:       // #<spill-kpi> @nested_hwloop spills=0 spill-bytes=0 reloads=0 reload-bytes=0
; ASM-NEXT:  // %bb.0: // %entry
; ASM-NEXT:    { xor32 r0, r0, r0; nop; nop }
; ASM-NEXT:    { subi32 sp, sp, 8; nop }
; ASM-NEXT:    .cfi_def_cfa_offset 8
; ASM-NEXT:    { addi32 r5, r0, 1; addi32 r4, r0, 0 }
; ASM-NEXT:    { max32 r3, r3, r5; move32 r5, r4; nop }
; ASM-NEXT:  .LBB2_1: // %outer.header
; ASM-NEXT:    // =>This Loop Header: Depth=1
; ASM-NEXT:    // Child Loop BB2_2 Depth 2
; ASM-NEXT:    { nop; set_hwloop_f2 1, .LLhwloop_start2, .LLhwloop_end2, r3; nop }
; ASM-NEXT:    { nop; nop; nop }
; ASM-NEXT:    { nop; nop; nop }
; ASM-NEXT:    { move32 r6, r1; nop; nop }
...
; ASM-NEXT:    { s_lw_post_imm r7, r6, 1; nop; nop }
; ASM-NEXT:    { nop; nop; nop }
; ASM-NEXT:    .p2align 2
; ASM-NEXT:  .LLhwloop_end2:
; ASM-NEXT:    { add32 r4, r4, r7; nop; nop }
; ASM-NEXT:  // %bb.3: // %outer.latch
; ASM-NEXT:    // in Loop: Header=BB2_1 Depth=1
; ASM-NEXT:    { addi32 r5, r5, 1; addi32 r1, r1, 4 }
; ASM-NEXT:    { slt32 r6, r5, r2; nop; nop }
; ASM-NEXT:    { bnez r6, .LBB2_1; nop; nop }
; ASM-NEXT:  // %bb.4: // %for.end
; ASM-NEXT:    { move32 r1, r4; nop; nop }
; ASM-NEXT:    { xor32 r0, r0, r0; nop; nop }
; ASM-NEXT:    { addi32 sp, sp, 8; nop }
; ASM-NEXT:    { nop; jalr r0, lr, 0; nop }
entry:
