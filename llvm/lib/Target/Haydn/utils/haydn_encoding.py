...
FORMAT_E_LAYOUT = "format_e_bit_layout_v2_1.json"
...
def load_syntax_order(database: Path) -> dict[str, list[str]]:
    ...
    `format_e_bit_layout_v2_1.json` lists an entry's fields in bit order, which
...
def verify_operand_sets(placements: list[dict],
    ...
    lines.append("format_e_bit_layout_v2_1.json, or correct the Syntax if the")
...
def emit_tablegen(geometry: dict, placements: list[dict],
    ...
    out: list[str] = [
        ...
        "//",
        "// Generated by utils/haydn_encoding.py from format_e_bit_layout_v2_1.json.",
        "//",
