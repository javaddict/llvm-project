//=- HaydnResourceScoreboard.h - Schedule Support -*- C++ -*-=
//
...
// Haydn target; the upstream llvm/CodeGen/ResourceScoreboard.h does not
// exist in this LLVM tree — See).
//
//===----------------------------------------------------------------------===//
//
// This file defines the ResourceScoreboard class template, which
// encapsulates hazard-avoidance heuristics for scheduling, based on the
// scheduling itineraries specified for the target.
//
// Vendored verbatim from llvm-aie (the AIE target's internal copy of this
// generic template). The template parameter RC is the per-cycle resource
// container (HaydnFuncUnitWrapper for the Haydn scoreboard packetizer).
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_HAYDN_HAYDNRESOURCESCOREBOARD_H
#define LLVM_LIB_TARGET_HAYDN_HAYDNRESOURCESCOREBOARD_H
...
#endif // LLVM_LIB_TARGET_HAYDN_HAYDNRESOURCESCOREBOARD_H
