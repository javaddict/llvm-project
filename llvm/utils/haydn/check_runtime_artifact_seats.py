...
def _self_test() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        (runtime / "PRODUCT-IDENTITY.txt").write_text(
            ...
            "direct control target is not an exact code record "
            "38bd4059 28700d57 T-ABI4 T-ABI6 T-ABI11 T-ABI12 i128 "
        ...
        try:
            ...
            # Stale 28700d57 full-gate commit is fail-closed (rebind 38bd4059).
            ...
            # Live monorepo: 38bd4059 is an ancestor; a missing object is not.
