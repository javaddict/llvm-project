...
//
// E2E: C surface __haydn_* AR unaligned builtins lower to llvm.haydn.* IR
...
int64_t c_lqhwua(int ptr, int stride) {
  return __haydn_d_lqhwua_post(ptr, 0, stride, 0);
}
...
int64_t c_ltwua(int ptr, int stride) {
  return __haydn_d_ltwua_post(ptr, 1, stride, 0);
}
...
void c_sqhwua(int64_t data, int ptr, int stride) {
  __haydn_d_sqhwua_post(data, ptr, 0, stride, 0);
}
...
void c_stwua(int64_t data, int ptr, int stride) {
  __haydn_d_stwua_post(data, ptr, 0, stride, 0);
}
...
int64_t c_stream_load(int base, int ptr, int stride) {
  __haydn_pldwwua(0, base);
  int64_t v = __haydn_d_lqhwua_post(ptr, 0, stride, 0);
  __haydn_flar(0);
  return v;
}
...
int64_t c_stream_ip(int *pptr, int stride) {
  return __haydn_d_lqhwua_post_ip(pptr, 0, stride, 0);
}
