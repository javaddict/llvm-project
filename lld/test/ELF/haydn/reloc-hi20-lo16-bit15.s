...
# bit 15 set (CB-76 class / D489 Format E).
#
# Format E LUI is HI12 (imm12 → bits[31:20], +0x80000 rounding) paired with
...
#
# Pre-Format-E HI20/LO16 MIPS 16/16 checks (lui 2 / addi -32768) are retired.
