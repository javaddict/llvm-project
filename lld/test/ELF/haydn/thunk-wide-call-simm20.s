...
#
# CB-112: out-of-range R_HAYDN_WIDE_CallSImm20 (JAL) must produce a
# long-call thunk — not "unrecognized relocation … for Haydn target".
#
# CodeGen selects jal for soft-div/libcalls → WIDE_CallSImm20. needsThunk
...
#   4. The call site is rewritten to a near jal (to the thunk), not left
...
.globl _start
_start:
    # WIDE call (JAL) → R_HAYDN_WIDE_CallSImm20.
    jal lr, far_callee
