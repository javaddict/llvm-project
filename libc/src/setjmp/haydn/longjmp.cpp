...
//
// Buffer layout must match setjmp.cpp / __jmp_buf.h (byte offsets shown here).
// ST32/LD32 imm is a word index (EA = base + imm<<2); ST64/LD64 imm is a dword
// index (EA = base + imm<<3) — see setjmp.cpp for the full rationale. The asm
// operands below are element indices, not byte offsets.
